...
r_text[1] = "teddye tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "teddy says i love you 😘";
r_text[3] = "teddyudeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "teddy - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per teddy ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than anshabdemon";
...
r_text[13] = ".song adich thangalude fav song name para teddy ath download aakki theraam";
...
r_text[18] = "enikk njan und teddy uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe teddy pazhaya teddy thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik teddyikk";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. teddy";
