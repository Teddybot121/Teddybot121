                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [Teddy] --*' + 
                                    ...
                                    '\n*Aslo you can join our support group:* https://chat.whatsapp.com/LIT28iiU5vw3OHPC4Vn6q5'
                                ...
                                if (error.message.includes('URL')) {
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*🙇🏻 Sorry, I Couldnt Read This Error! 🙇🏻*' +
                                        '\n_You can write to our support group for more help /nhttps://chat.whatsapp.com/LIT28iiU5vw3OHPC4Vn6q5._'
                                        , MessageType.text
                                    );
                                }    
                            }                      
